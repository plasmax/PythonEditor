...
def QTabBarPrivate::makeVisible(int index)
...
def QTabBarPrivate::killSwitchTabTimer()
...
def QTabBarPrivate::layoutTab(int index)
...
def QTabBarPrivate::layoutWidgets(int start)
...
def QTabBarPrivate::autoHideTabs()
...
def QTabBarPrivate::_q_closeTab()
...
def QTabBarPrivate::_q_scrollTabs()
...
def QTabBar::setShape(Shape shape)
...
def QTabBar::setDrawBase(bool drawBase)
...
r"""!
 ...
 r"""
def QTabBar::removeTab(int index)
...
r"""
def QTabBar::setTabEnabled(int index, bool enabled)
...
r"""
def QTabBar::setTabText(int index, const QString &text)
...
r"""!
    ...
    \sa tabTextColor()
r"""
def QTabBar::setTabTextColor(int index, const QColor &color)
...
r"""
def QTabBar::setTabIcon(int index, const QIcon & icon)
...
r"""
def QTabBar::setTabToolTip(int index, const QString & tip)
...
r"""!
    ...
    to \a text.
r"""
def QTabBar::setTabWhatsThis(int index, const QString &text)
...
r"""
def QTabBar::setTabData(int index, const QVariant & data)
...
def QTabBar::setCurrentIndex(int index)
...
def QTabBar::setIconSize(const QSize &size)
...
r"""!
  ...
  \sa tabRemoved()
 r"""
def QTabBar::tabInserted(int index)
...
r"""!
  ...
  \sa tabInserted()
 r"""
def QTabBar::tabRemoved(int index)
...
r"""!\reimp
 r"""
def QTabBar::showEvent(QShowEvent *)
...
r"""!\reimp
 r"""
def QTabBar::hideEvent(QHideEvent *)
...
r"""!\reimp
 r"""
def QTabBar::resizeEvent(QResizeEvent *)
...
r"""!\reimp
 r"""
def QTabBar::paintEvent(QPaintEvent *)
...
r"""
 ...
 r"""
int QTabBarPrivate::calculateNewPosition(int _from, int to, int index) const

    if (index == _from)
        return to;

    int start = qMin(_from, to);
    int end = qMax(_from, to);
...
r"""!
    Moves the item at index position \a _from to index position \a to.
    \since 4.5

    \sa tabMoved(), tabLayoutChange()
 r"""
def QTabBar::moveTab(int _from, int to)
    ...
    int start = qMin(_from, to);
    int end = qMax(_from, to);
    int width = vertical ? d->tabList[_from].rect.height() : d->tabList[_from].rect.width();
    if (_from < to)
        width *= -1;
    ...
    if (vertical)
        if (_from < to)
            d->tabList[_from].rect.moveTop(d->tabList[to].rect.bottom() + 1);
        else
            d->tabList[_from].rect.moveTop(d->tabList[to].rect.top() - width);
     else
        if (_from < to)
            d->tabList[_from].rect.moveLeft(d->tabList[to].rect.right() + 1);
        else
            d->tabList[_from].rect.moveLeft(d->tabList[to].rect.left() - width);


    # Move the actual data structures
    d->tabList.move(_from, to);

    # update lastTab locations
    for (int i = 0; i < d->tabList.count(); ++i)
        d->tabList[i].lastTab = d->calculateNewPosition(_from, to, d->tabList[i].lastTab);

    # update external variables
    int previousIndex = d->currentIndex;
    d->currentIndex = d->calculateNewPosition(_from, to, d->currentIndex);

    # If we are in the middle of a drag update the dragStartPosition
    if (d->pressedIndex != -1)
        d->pressedIndex = d->calculateNewPosition(_from, to, d->pressedIndex);
...
def QTabBarPrivate::slide(int _from, int to)
    ...
    if (_from == to
        ...
        return;
    bool vertical = verticalTabs(shape);
    int preLocation = vertical ? q->tabRect(_from).y() : q->tabRect(_from).x();
...
def QTabBarPrivate::moveTab(int index, int offset)
...
r"""!\reimp
r"""
def QTabBar::mousePressEvent(QMouseEvent *event)
...
r"""!\reimp
 r"""
def QTabBar::mouseMoveEvent(QMouseEvent *event)
...
def QTabBarPrivate::setupMovableTab()
    ...
    # Re-arrange widget order to adef overlaps
...
def QTabBarPrivate::moveTabFinished(int index)
...
r"""!\reimp
r"""
def QTabBar::mouseReleaseEvent(QMouseEvent *event)
...
r"""!\reimp
 r"""
def QTabBar::keyPressEvent(QKeyEvent *event)
...
def QTabBar::wheelEvent(QWheelEvent *event)
...
def QTabBarPrivate::setCurrentNextEnabledIndex(int offset)
...
r"""!\reimp
 r"""
def QTabBar::changeEvent(QEvent *event)
...
r"""!
    \reimp
r"""
def QTabBar::timerEvent(QTimerEvent *event)
...
def QTabBar::setElideMode(Qt::TextElideMode mode)
...
def QTabBar::setUsesScrollButtons(bool useButtons)
...
def QTabBar::setTabsClosable(bool closable)
...
def QTabBar::setSelectionBehaviorOnRemove(QTabBar::SelectionBehavior behavior)
...
def QTabBar::setExpanding(bool enabled)
...
def QTabBar::setMovable(bool movable)
...
def QTabBar::setDocumentMode(bool enabled)
...
def QTabBar::setAutoHide(bool hide)
...
def QTabBar::setChangeCurrentOnDrag(bool change)
...
r"""!
    ...
    \sa tabsClosable()
  r"""
def QTabBar::setTabButton(int index, ButtonPosition position, QWidget *widget)
...
r"""
def QTabBar::setAccessibleTabName(int index, const QString &name)
...
def CloseButton::enterEvent(QEvent *event)
...
def CloseButton::leaveEvent(QEvent *event)
...
#if QT_CONFIG(animation)
def QTabBarPrivate::Tab::TabBarAnimation::updateCurrentValue(const QVariant &current)

    priv->moveTab(priv->tabList.indexOf(*tab), current.toInt());


def QTabBarPrivate::Tab::TabBarAnimation::updateState(QAbstractAnimation::State, QAbstractAnimation::State newState)
